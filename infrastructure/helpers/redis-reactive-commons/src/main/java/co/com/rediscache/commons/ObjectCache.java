package co.com.rediscache.commons;
...
public interface ObjectCache<T> {
     ...
     * @return a Mono containing a boolean result. True if key-value is evicted from cache, false
     * otherwhise.
     */
     ...
     *
     * @return a Mono containing a boolean result. True if all keys were evicted from cache, false
     * otherwhise.
     */
